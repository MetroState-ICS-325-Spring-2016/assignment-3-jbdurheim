...
// tables together.
//read in the contents of the Question_6.sql file to get the SQL query text
$sql_statement =  file_get_contents("Question_6.sql");
$query_result = $mysql_connection->query($sql_statement);
